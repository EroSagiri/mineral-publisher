...
use crate::publisher::{
    GitCommitOid, PublicationTarget, PublishRunId, RemoteObservationId, RemoteObservationStore,
...
fn row_to_observation(row: &rusqlite::Row<'_>) -> rusqlite::Result<RemoteRefObservation> {
    ...
    let target = PublicationTarget::new(row.get::<_, String>(2)?, row.get::<_, String>(3)?)
...
mod tests {
    ...
    use crate::{
        ...
        publisher::{GitRepositoryIdentity, PublishRun, PublishRunPublication},
